# FPVGate v1.5.6 Release Binaries
...
### Highlights
- 🔋 High-precision battery voltage monitoring (uint16 range)
- 🔋 Configurable voltage divider ratio for custom hardware
- 🎨 Visual battery indicator in UI header
- 🎨 Dynamic battery icon states (full/mid/low)
- 🐛 Fixed battery voltage precision issues
- 🐛 Fixed voltage divider configuration persistence
